...
{ //start
      ...
      do
    {
       cout << "Hi! Would you like to know your birthstone? Please enter your name so we can get to know you better \n";
        getline(cin, text);
        cout << "Nice to meet you " << text << "! Now please enter your birthday using a two digit month and two digit year, for example if you were born on July 13st you would enter 07/31 \n";
         cin >> month >> space >> day;
        ...
        cout << "Would You like to Find Another Birthstone? (Please Type y or N)\n ";
        cin >> ans;
