...

{
      ...
      do
    {
       cout << "Hi! Would you like to know your birthstone? Please enter your name so we can get to know you better \n";
        ...
        cout << "Nice to meet you " << text << "! Now please enter your birthday using a two digit month and two digit day, for example if you were born on July 31st you would enter 07/31 \n";
         cout<<"enter month:";
        cin>>month;
        cout<<"enter day:";
	cin>>day;
